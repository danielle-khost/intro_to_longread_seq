...
def parse_args():
    ...
    parser.add_argument(
        '--gff', type=str, required=True,
        help='Output GFF file containing genomic locations and repeat units of microsatellites.')
            ...
            for line in dat:
                ...
                if line.startswith("Sequence:"):
                    ...
                    try:
                        ...
                        motif = splitline[13]
                        bed.write('\t'.join([chrom,"TRF","similarity",start,end,".",".",".","Target \"Motif:"+motif+"#Tandem_repeat\""]) + '\n')
                    except IndexError:
                        pass
